...
--
-- Client :  localhost
-- Généré le :  Ven 31 Août 2018 à 16:04
...
--
-- Structure de la table `customer_purchase`
--
...
--
-- Index pour la table `customer_purchase`
--
ALTER TABLE `customer_purchase`
  ADD PRIMARY KEY (`fk_customer`,`fk_purchase`),
...
ALTER TABLE `product_purchase`
  ADD PRIMARY KEY (`fk_purchase`,`fkProduct`),
...
--
-- Contraintes pour la table `customer_purchase`
--
ALTER TABLE `customer_purchase`
  ADD CONSTRAINT `customer_purchase_ibfk_1` FOREIGN KEY (`fk_customer`) REFERENCES `customer` (`customerId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `customer_purchase_ibfk_2` FOREIGN KEY (`fk_purchase`) REFERENCES `purchase` (`purchaseId`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `product_purchase`
--
ALTER TABLE `product_purchase`
  ADD CONSTRAINT `edit_Orders_FK` FOREIGN KEY (`fk_purchase`) REFERENCES `purchase` (`purchaseId`),
