...
//Requêtes pour l'objet produit
    ...
    //Récupérer tout les produits trié par .... décroissant
        ...
        function getProductOrderByDesc($orderBy){
            ...
            $products = $db->query('SELECT * FROM products ORDER BY '.$orderBy.' DESC');
    ...
    //Récupérer tout les produits trié par .... croissant
        ...
        function getProductOrderByAsc($orderBy){
            ...
            $products = $db->query('SELECT * FROM products ORDER BY '.$orderBy.' ASC');
    ...
    //Ajouter un produit
...

        {
            ...
            $req = $db->prepare('INSERT INTO products(product_name,product_price,product_stock,product_place,product_description,product_size,product_weight,product_reference,product_state)
    ...
    //Récupérer un produit par son id
        ...
        function getProduitById($produit_id){
            ...
            $response = $db->query('SELECT * FROM products WHERE produit_id = '.$produit_id);
    ...
    //Retiré un produit
        ...
        function cancelProduct($product_id){
            ...
            $req = $db->query('UPDATE products SET product_state = "Retiré" WHERE product_id ='.$product_id);
...
//Requête objet commande
    ...
    //Récupérer les commandes trié par ..... décroissant 
        ...
        function getOrderOrderByDesc($orderBy){
            ...
            $orders = $db->query('SELECT * FROM Orders ORDER BY '.$orderBy.' DESC');
    ...
    //Récupérer les commandes trié par .... croissant
        ...
        function getOrderOrderByAsc($orderBy){
            ...
            $orders = $db->query('SELECT * FROM Orders ORDER BY '.$orderBy.' ASC');
    ...
    //Ajouter une commande >>>> table nom Orders
        ...
        function addOrder($order_products,$order_quantity,$order_price,$order_reduction,$order_postal_charges,$order_totalprice,$order_taxes,$order_delivery_address,$order_billing_address,$order_date,$order_state,$order_delivery_date,$customer_id){
            ...
            $req = $db->prepare('INSERT INTO Orders(order_products,order_quantity,order_price,order_reduction,order_postal_charges,order_totalprice,order_taxes,order_delivery_address,order_billing_address,order_date,order_state,order_delivery_date,customer_id)
 ...
 /*modif*/  $response = $db->query('SELECT * FROM Orders WHERE order_id = '.$order_id);
    ...
    //Annulé une commande
        ...
        function cancelOrder($order_id){
            ...
            $req = $db->query('UPDATE Orders SET order_state = "Annulé" WHERE order_id ='.$order_id);
...
//Requêtes des customers
    ...
    //Récupérer les customers trié par ..... décroissant
        ...
        function getcustomerOrderByDesc($orderBy){
            ...
            $customers = $db->query('SELECT * FROM customers ORDER BY '.$orderBy.' DESC');
    ...
    //Récupérer un customers par son id
        ...
        function getcustomerById($customer_id){
            ...
            $response = $db->query('SELECT * FROM customers WHERE customer_id = '.$customer_id);
